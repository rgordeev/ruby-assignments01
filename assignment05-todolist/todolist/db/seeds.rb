...
#users = User.create([{ username: 'Fiorina', password_digest: 'xxx'}, { username: 'Trump', password_digest: 'xxx'}, {username: 'Carson', password_digest: 'xxx'}, {username: 'Clinton', password_digest: 'xxx'}])
users = User.create([{ :username => "Fiorina", :password_digest => "xxx"},
